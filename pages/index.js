...
export default function App() {
  ...
  const systems = ["debian-10", "debian-11", "Amazon-Linux-2", "ubuntu-20.04", "ubuntu-22.04", "arch-linux", "windows-server-2022-sc", "windows-server-2022-en"];
  const systemsDetail = ["Debian 10", "Debian 11", "Amazon Linux2", "Ubuntu 20.04", "Ubuntu 22.04", "Arch Linux", "Windows Server 2022 简体中文版", "Windows Server 2022 英文版"];
